...
ns_atendimentos_hospitalares = Namespace("Atendimentos Hospitalares",
...
def aggregate_by_care(collection, rows):
    return_attributes = {'medico': 'Médico', 'enfermeiro': 'Enfermeiro', 'outros': 'Outros'}
...
@ns_atendimentos_hospitalares.route("/atendimentos/regions/<region>", strict_slashes=False)
...
@ns_atendimentos_hospitalares.route("/atendimentos/states/<state>", strict_slashes=False)
...
@ns_atendimentos_hospitalares.route("/atendimentos/cities/<ibge>", strict_slashes=False)
