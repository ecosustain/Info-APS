...
def process_csv_file(file, collection_name, progress_id):
    """
    ...
    :param progress_id: progress_id bar
    """
    ...
    with open(file_path, newline='', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            ...
            step += 1
            progress_manager.set_progress(progress_id,  int(((step + 1) / total_records) * 100), f'{step}/{total_records}')
        ...
        if collection.count_documents({}) > 0:
            update_collection_attributes(collection_name)
