...
class DataImportProfile(AuditableEntity):
    ...
    data_import_category = models.ForeignKey(
        DataImportCategory, on_delete=models.CASCADE
    )
...
class DataImportParam(AuditableEntity):
    ...
    data_import_profile = models.ForeignKey(
        DataImportProfile, on_delete=models.CASCADE, related_name="params"
    )
    active = models.BooleanField(default=True)
...
class DataImportLog(models.Model):
    ...
    data_import_profile = models.ForeignKey(
        DataImportProfile, on_delete=models.CASCADE
    )
