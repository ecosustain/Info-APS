...
class IndividualCare(HealthCore):
    geo_unit_macro_region = models.ForeignKey(
        GeoUnit,
        on_delete=models.CASCADE,
        related_name="individual_care_geo_unit_macro_region",
    )
    geo_unit_state = models.ForeignKey(
        GeoUnit,
        on_delete=models.CASCADE,
    ...
    individual_category = models.ManyToManyField(
        IndividualCategory, through="IndividualCareCategory"
    )
...
class IndividualCareCategory(HealthCoreCategory):
    individual_care = models.ForeignKey(
        IndividualCare, on_delete=models.CASCADE
    )
    individual_category = models.ForeignKey(
        IndividualCategory, on_delete=models.CASCADE
    )
